...
$lang['home-a-html']='<div class="yf_dx"></div>
        <div class="yf_01">
            <div class="yf_img"><img src="/resources/images/common/yfimg01.jpg" alt="R＆D" /></div>
            <h1><a href="/welcome/catalog/311">多孔質材料の国立研究所</a></h1>
            <h2>金属繊維の調製技術、金属繊維多孔質材料の準備理論材料特性と理論研究のアプリケーションを実行するための研究所は、同社のR＆D機能を強化するための強固な基盤を築きました。</h2>
        </div>
        <div class="yf_01">
            <div class="yf_img"><img src="/resources/images/common/yfimg02.jpg" alt="R＆D" /></div>
            <h1><a href="/welcome/catalog/312">市営企業技術センター</a></h1>
            <h2>製品開発における技術センター、経営革新、技術革新、産業オートメーション、省エネ•排出削減、独自のコア独自の技術の形成は、企業自体に積極的な役割だけでなく、産業の急速な発展を果たしてきました。</h2>
        </div>';



$lang['home-b-name']='会社の概要';
$lang['home-b-html']=' <div class="gs_dx"></div>
        <div class="gs_info">
            <h1>	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;フュルト金属フィルター材料有限公司の西安は、金属繊維およびその製品のR＆Dと製造企業におけるグローバルリーダーです。主な製品は金属繊維であり、金属繊維のフェルト、焼結金属、金属フィルターや他の多孔性の金属材料の焼結金網層は、広く化学繊維、石油化学、繊維、環境保護、自動車、電気、および他の分野に適用される。</h1>
        </div>
        <div class="gs_info02">
            <ul>
                <li>1993年に設立され</li>
                <li>同国最大の金属繊維およびその製品の生産拠点。</li>
                <li>金属繊維の300トンの年間生産量</li>
                <li>15万平方メートル年は焼結フィルター</li>
                <li>ナショナル多孔性材料研究室サポートユニット</li>
                <li>クマ15国と地方の主要プロジェクト</li>
                <li>9認可された特許</li>
                <li>西部材の保持子会社（深セン証券取引所上場企業、証券コード002149）</li>
            </ul>
        </div>';
...
$lang['home-d-name']='特産品';
$lang['home-d-html']='<div class="cp_dx"></div>
        <div class="cpimg">
            <ul>
                <li><img src="/resources/images/common/cpimg01.jpg" alt="特産品" /></li>
                <li><img src="/resources/images/common/cpimg02.jpg" alt="特産品" /></li>
                <li><img src="/resources/images/common/cpimg03.jpg" alt="特産品" /></li>
            </ul>
        </div>
        <div class="cpinfo">
            <ul>
...
$lang['home-e-html']=' <div class="yy_dx"></div>
        <div class="yy_info">
            ...
            <div class="yy_info02">
                ...
                <h2>アイアンブランド触媒吸着、高気孔率、およびスルーホールの度合燃焼ガスの全額、熱伝導率の高いキャリア急速加熱性能、耐高温酸化性、基材の高強度、熱振動性能を向上させるために高い幾何学的表面積を有するアルミニウム繊維マットかなりの利益、微粒子トラップ装置（DPF）を持つ自動車の排気ガス浄化の生産のための優れた材料。</h2>
            </div>
        </div>
        <div class="yy_info">
            <h1>バーナー</h1>
            <div class="yy_info02">
                ...
                <h2>バーナーヘッドは、金属繊維編組、金属繊維編組を通って燃焼室で燃焼ガスの層が配置されている。効果的に燃焼室の温度分布を制御するために、放射と対流熱伝達急速な普及によってとても小さい金属繊維の小さなギャップだけでなく、良好な熱伝達特性、その燃焼熱から流れる空気の混合気の流れ、 - 金属繊維は均一な気流、ガスであってもよい、燃焼室内の局所高温を避ける。</h2>
            </div>
        </div>
        <div class="yy_info">
            <h1>高温ガス粉塵</h1>
            <div class="yy_info02">
                ...
                <h2>繊維マットの鉄のブランドアルミろ過効率、高気孔率、低抵抗は、成形プロセスを容易にするために、十分な強度と靭性を持っているが、防錆性能、（1000℃までの温度に使用）、良好な高温があり、煤が良い持っているフィルタリングの有効性と効率性、優れた再生能力、長寿命、省エネ効果が顕著である.</h2>
            </div>
        </div>';



$lang['home-f-name']='品質管理';
$lang['home-f-html']='<div class="zl_dx"></div>
        <div class="zl_info">
            <ul>
                <li><a href="/welcome/catalog/41">品質方針</a></li>
                <li><a href="/welcome/catalog/42">品質管理システム</a></li>
                <li><a href="/welcome/catalog/43">検出システムの厳密な分析</a></li>
                <li><a href="/welcome/catalog/44">厳密なプロセス制御</a></li>
            </ul>
        </div>';



$lang['home-g-name']='関連リンク';
